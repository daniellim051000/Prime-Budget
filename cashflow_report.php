    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">“There are three types of lies -- lies, damn lies, and statistics.”</p>
		...
		<div class="col-xl-8 col-lg-7">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Cashflow Report</h6>
            </div>
            <div class="card-body" id="chart_div">
				...
				<!-----------right----------------->
			<?php
			$userid=intval($_SESSION['mySession']);
			$sql="SELECT `transaction`.`category`, `transaction`.`amount`, `account`.`account_id`, `transaction`.`record_id`
FROM `transaction` 
	LEFT JOIN `account` ON `transaction`.`account_id` = `account`.`account_id` WHERE account.user_id='$userid'";
			...
			?>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Income and Expense Record</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
					...
					echo $row['amount'];
					echo "</td>";
					echo "<td><a href=\"updaterecord.php?record_id=";
					echo $row['record_id'];
					echo "\">View Record</a></td>";
