          ...
          <div class="row">
            ...
            <!-- Project Card Example -->
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <h4 class="small font-weight-bold">Cash Out / In<span class="float-right" id="current_progress"></span></h4>
                  ...
                  <h4 class="small font-weight-bold">Return Amount<span class="float-right" id="current_progress1"></span></h4>
