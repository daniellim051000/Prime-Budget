             ...
             <form class="user" action="addrecordquery.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <select name="category" class="custom-select">
						...
						<option value="Communication">Communication & PC</option>
					...
					<div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail" name="amount" placeholder="Enter Amount" required>
                    </div>
                    
                    <div class="form-group">
                      <label  for="type">description</label><br>
                      <input type="text" class="form-control" id="exampleInputEmail" name="description" placeholder="Enter Details">
                    </div>
                    
                    <div class="form-group">
                      <label  for="type">Account</label><br>
