...
<body id="page-top">
  ...
  <!-- Content Row -->
	...
	$result = mysqli_query($con,"SELECT * FROM goal WHERE goal_id=$id"); 
	...
	?>
      ...
      <form action="Updategoal.php" method="post">
      		  <div class="form-group">
      			...
      			<input name="goal_id" type="hidden" class="form-control" id="exampleFormControlInput1" value="<?php echo $row['goal_id']?>">

			    <label for="exampleFormControlInput1">Name</label>
			    <input name="name" type="text" class="form-control" id="exampleFormControlInput1" value="<?php echo $row['goal_name']?>">
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlInput1">Amount Needed</label>
			    <input name="need_amount" type="text" class="form-control" id="exampleFormControlInput2" value="<?php echo $row['amount_needed']?>">
			  </div>
			    <div class="form-group">
			    <label for="exampleFormControlInput1">Amount Hold</label>
			    <input name="hold_amount" type="text" class="form-control" id="exampleFormControlInput3" value="<?php echo $row['amount_hold']?>">
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlInput1">Remark</label>
			    <input name="description" type="text" class="form-control" id="exampleFormControlInput4" value="<?php echo $row['remark']?>"> 
			    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Delete Goal</h5>
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo"Deletegoal.php.?goal_id=" . $id?>" class="btn btn-danger">Delete</a>
      </div>
    </div>
  </div>
</div>
