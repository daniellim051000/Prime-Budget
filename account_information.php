        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Select Account</h6>
            </div>
            <div class="card-body">
             <?php include("conn.php");
				$result2 = mysqli_query($con,"SELECT * FROM account where user_id='$user_id'");}
				?>
				...
				echo "<td><a href=\"account.php?account_id=";
				echo $row['account_id'];
				echo "\">View</a></td>";
				}
