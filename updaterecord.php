      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
             <form class="user" action="addrecordquery.php" method="post">
                    <div class="form-group">
                      <label  for="type">Type of Record</label><br>
						<input name="recid" value="<?php echo $row['record_id']?>" type="hidden">
                      <select name="type" class="form-control-plaintext" disabled>
                    ...
                    <input class="form-control-plaintext" type="date" name="date" min="<?php echo date("Y-m-d");?>" value="<?php echo $row['date'] ?>" readonly>
					</div>
					
                    <div class="form-group">
                      <label  for="category">Category</label><br>
                      <select name="category" class="form-control-plaintext" disabled>
					...
					<div class="form-group">
                      ...
                      <input type="number" class="form-control-plaintext" id="exampleInputEmail" name="amount" placeholder="Enter Amount" value="<?php echo $row['amount'] ?>" readonly>
                    </div>
                    
                    <div class="form-group">
                      <label  for="type">description</label><br>
                      <input type="text" class="form-control-plaintext" id="exampleInputEmail" name="description" placeholder="Enter Details" value="<?php echo $row['description'] ?>" readonly>
                    </div>
                   
                    <a href="<?php echo"updaterecord1.php.?recid=$row[record_id]"?>" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="far fa-edit"></i>
                    </span>
                    <span class="text">Update</span>
                  </a>
                    <a href="<?php echo "deleterecord.php?recid=$row[record_id]"?>" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
