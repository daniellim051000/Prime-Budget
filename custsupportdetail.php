    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="UserDetail.php">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Customer Support</h1>
          <p class="mb-4">"When you assume negative intent, you're angry. If you take away that anger and assume positive intent, you will be amazed." </p>

          <!-- DataTales Example -->
          <?php
          include("conn.php");
          $cus_sup_id = intval($_GET['cus_sup_id']);
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
             <?php include("conn.php");
				$result2 = mysqli_query($con,"SELECT * FROM customer_support where cus_sup_id='$cus_sup_id'");}
			 ?>
			...
			{
			?>
			 <form class="user" action="custsupportins.php" method="post">
                    <div class="form-group">
                    <label for="cus_sup_id"><b>Customer Support</b></label>
                    <input type="text" class="form-control-plaintext" id="exampleInputEmail" name="cus_sup_id" value="<?php echo $row['cus_sup_id'] ?>" readonly >
                    </div>
                    <div class="form-group">
                    <label for="title"><b>Title</b></label>
                      <input type="text" class="form-control-plaintext" id="exampleInputPassword" name="title" value="<?php echo $row['title'] ?>" readonly>
					</div>
					<div class="form-group">
					<label for="description"><b>Description</b></label>
                      <input type="text" class="form-control-plaintext" id="exampleInputPassword" name="description" value="<?php echo $row['description'] ?>"readonly>
					</div>
					<div class="form-group">
					<label for="respond"><b>Respond:</b></label>
                      <input type="text" class="form-control-plaintext" id="exampleInputPassword" name="respond" value="<?php echo $row['respond'] ?>" readonly>
					</div>
					<div class="form-group">
					<label for="status	"><b>Status</b></label>
                      <input type="text" class="form-control-plaintext" id="exampleInputPassword" name="status" value="<?php echo $row['status'] ?>" readonly>
					</div>
