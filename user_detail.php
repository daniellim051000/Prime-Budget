...
<?php
            include("conn.php");
           	include("session.php");
	       $currentuser=$_SESSION['mySession'];
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="">Goal</a>
            <a class="collapse-item" href="">Debt</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
	       ...
	       $sql="SELECT * from user where user_id='$currentuser'";
         ...
         ?>
		  ...
		  <input type="hidden" name="id" value="<?php echo $row['user_id']?>">
			...
			<div class="col-sm-10">
			  <input type="text" name="name" value="<?php echo $row['name']?>" class="form-control-plaintext" readonly>
			</div>
		  </div>
		   ...
		   <div class="form-group row">
			...
			<div class="col-sm-10">
			  <input type="text" name="age" value="<?php echo $row['age']?>" class="form-control-plaintext" readonly >
			</div>
		  </div>
			...
			<div class="col-sm-10">
			  <input type="text" name="gender" value="<?php echo $row['gender']?>" class="form-control-plaintext" readonly>
			</div>
		  </div>
			...
			<div class="col-sm-10">
			  <input type="email" name="email" value="<?php echo $row['email']?>" class="form-control-plaintext" readonly>
			</div>
		  </div>
			...
			<div class="col-sm-10">
			  <input type="text" name="phone_no" value="<?php echo $row['phone_no']?>" class="form-control-plaintext" readonly>
			</div>
		  </div>
					<a class="btn btn-primary btn-icon-split" href="UserDetail.php">
