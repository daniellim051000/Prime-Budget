    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">“We all need people who will give us feedback. That’s how we improve.”</p>
          ...
          <div class="card shadow mb-4">
			...
			<div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="svg/feedback.svg" alt="">
                  </div>
          ...
          ?>
					...
					<div class="row justify-content-center text-center py-4 px-0">
 					 <div class="col-10">
	    					<p class="mx-auto">
	   				   How much you like it?
   						 ...
   						 <label for="customRange2">Very Bad.........Bad..........Moderate........Good........Very Good</label>
						<input type="range" class="custom-range" name="rating" min="1" max="5" id="customRange2">	
						</div>							 
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputPassword" name="description" placeholder="Enter description" required>
					</div>
                    <div class="form-group">
