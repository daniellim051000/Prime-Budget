...
<body id="page-top">
  ...
  <!-- Content Row -->
	 ...
	 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
         <h6 class="m-0 font-weight-bold text-primary">Add Debt</h6>
	</div>
		<div class="card-body">
      <form action="AddDebt.php" method="post">
      		  <div class="form-group">
      			<input name="userid" type="hidden" class="form-control" id="exampleFormControlInput1" value="<?php echo $_SESSION['mySession']?>">
      			<input name="id" type="hidden" class="form-control" id="exampleFormControlInput2">
				<div class="form-group">
                      <label for="type">Type of Debt</label><br>
			    ...
			    <input name="name" type="text" class="form-control" id="exampleFormControlInput3" required>
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlInput1">Total Borrow/Lend Amount</label>
			    <input name="cashOutIn" type="number" class="form-control" id="exampleFormControlInput4" required>
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlInput1">Payback Amount</label>
			    <input name="returnback" type="number" class="form-control" id="exampleFormControlInput6">
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlInput1">Remark</label>
			    <input name="description" type="text" class="form-control" id="exampleFormControlInput7">
			  </div>
