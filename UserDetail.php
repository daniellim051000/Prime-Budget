      ...
      <li class="nav-item">
        ...
        <div id="collapseReport" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="">Expenses Report</a>
			<a class="collapse-item" href="">Cash Flow Report</a>
          </div>
        </div>
      </li>
         ...
         ?>
		  ...
		  <input type="hidden" name="id" value="<?php echo $row['user_id']?>">
		   ...
		   <div class="form-group row">
			...
			<div class="col-sm-10">
			  <input type="text" name="phone_no" value="<?php echo $row['phone_no']?>" class="form-control" >
			</div>
		  </div>
