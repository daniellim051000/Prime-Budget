    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">“Don't tell me what you value, show me your budget, and I'll tell you what you value.”</p>
		...
		?>
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary"><?php echo $row['account_name'];?></h6>
            </div>
            <div class="card-body">
				<form action="#" method="post"> 
				<div class="form-group ">
					<input type="hidden" name="account_id" value="<?php echo $row['account_id'];?>">
					<label for="colFormLabelLg" class="col-sm-2 col-form-label">Account Name</label>
					<div class="col-sm-10">
					  <input type="Text" readonly class="form-control-plaintext" id="colFormLabelLg" name="user_id" value="<?php echo $row['account_name'];?>">
					</div>
				  </div>

				  <div class="form-group ">
					<label for="colFormLabelLg" class="col-sm-2 col-form-label">Current Amount</label>
					<div class="col-sm-10">
					  <input type="text" readonly class="form-control-plaintext" id="colFormLabelLg" value="<?php echo $row['total_amount'];?>">
					</div>
				  </div>
					<a class="btn btn-light btn-icon-split" href="edit_account.php?account_id=<?php echo $row['account_id'];?>">
                    <span class="icon text-gray-600">
                      <i class="fas fa-edit"></i>
                    </span>
                    <span class="text">Adjust Balance & Edit Account</span>
                  </a>
				 <a href="viewrecord1.php?account_id=<?php echo $row['account_id']; ?>" class="btn btn-info btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-list-ul"></i>
                    </span>
                    <span class="text">View All Record</span>
                  </a>
				</form>
            </div>
