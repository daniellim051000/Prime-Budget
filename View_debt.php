...
<body id="page-top">
  ...
  <!-- Content Row -->
	...
	$result = mysqli_query($con,"SELECT * FROM debt WHERE debt_id=$id"); 
	while($row = mysqli_fetch_array($result)) 
	{
	?>

      <form action="UpdateDebt.php" method="post">
      		  <div class="form-group">
      			<input name="userid" type="hidden" class="form-control" id="exampleFormControlInput1" value="<?php echo $_SESSION['mySession']?>">
      			<input name="debt_id" type="hidden" class="form-control" id="exampleFormControlInput2" value="<?php echo $row['debt_id']?>">

			    <label for="exampleFormControlInput1">Name</label>
			    <input name="name" type="text" class="form-control" id="exampleFormControlInput3" value="<?php echo $row['debt_name']?>">
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlInput1">Cash Out / In</label>
			    <input name="cashOutIn" type="number" class="form-control" id="exampleFormControlInput4" value="<?php echo $row['cash_OutIn']?>">
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlInput1">Return</label>
			    <input name="returnback" type="number" class="form-control" id="exampleFormControlInput5" value="<?php echo $row['return_back']?>">
			  </div>
			  <div class="form-group">
			    <label for="exampleFormControlInput1">Remark</label>
			    <input name="description" type="text" class="form-control" id="exampleFormControlInput6" value="<?php echo $row['remark']?>">
			  </div>			 
			 ...
			 <!--<button name="delete" type="submit" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash-alt"></i>
                    </span>
                   <span onclick="delete();" class="text">Delete</span>
                  </button>-->
                  <!--<a href="<?php echo"Deletegoal.php.?goal_id=$row[goal_id]"?>" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="far fa-trash"></i>
                    </span>
                    <span class="text">Delete</span>
                  </a>-->
                 <a type="button" class="btn btn-danger btn-icon-split" href="#" data-toggle="modal" data-target="#staticBackdrop">
				   <span class="icon text-white-50">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Delete Debt</h5>
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo"DeleteDebt.php.?debt_id=" . $id?>" class="btn btn-danger">Delete</a>
      </div>
    </div>
  </div>
</div>
