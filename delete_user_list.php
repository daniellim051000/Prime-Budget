        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Deleted User</h6>
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      ...
                      <a class="dropdown-item" href="user_list.php">Active User</a>
                    </div>
                  </div>
                </div>
			...
			$result=mysqli_query($con,"SELECT* FROM user where status='inactive';");
			?>
            <div class="card-body">
                    ...
                    <tr>
					  ...
					  <tbody>
						...
						while($row=mysqli_fetch_array($result))
						{
							...
							echo "<td><a href=\"restore_user.php?user_id=";
							echo $row['user_id'];
							echo "\">View</a></td></tr>"; 
